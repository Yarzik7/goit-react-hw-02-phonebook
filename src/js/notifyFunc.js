...
const notifyFailure = (message, timeout) => Notify.failure(message, { timeout: timeout });

const notifySuccsess = (message, timeout) => Notify.success(message, { timeout: timeout });

const notifyInfo = (message, timeout) => Notify.info(message, { timeout: timeout });
